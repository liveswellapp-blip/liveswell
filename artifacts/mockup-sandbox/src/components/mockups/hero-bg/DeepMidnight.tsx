export default function DeepMidnight() {
  return (
    <div style={{ background: "#030a14", padding: 16, fontFamily: "'Inter', sans-serif" }}>
      <div style={{ borderRadius: 20, overflow: "hidden", position: "relative", background: "linear-gradient(160deg, #060d1c 0%, #0b1830 50%, #071628 100%)", border: "1px solid rgba(16,185,129,0.2)" }}>
        <div style={{ position: "relative", padding: "20px 20px 20px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 12 }}>
            {[
              ...
              <div key={b.label} style={{ background: "rgba(255,255,255,0.04)", borderRadius: 12, padding: 12, border: "1px solid rgba(16,185,129,0.25)" }}>
          ...
          <div style={{ background: "rgba(255,255,255,0.04)", borderRadius: 12, padding: 12, border: "1px solid rgba(16,185,129,0.25)" }}>
      ...
      <div style={{ marginTop: 8, textAlign: "center", color: "#475569", fontSize: 11, fontWeight: 600 }}>B · Deep Midnight Blue</div>
    </div>
  );
}
