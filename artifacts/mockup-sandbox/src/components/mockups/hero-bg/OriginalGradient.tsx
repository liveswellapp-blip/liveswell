export default function OriginalGradient() {
  return (
    <div style={{ background: "#030a14", padding: 16, fontFamily: "'Inter', sans-serif" }}>
      <div style={{ borderRadius: 20, overflow: "hidden", position: "relative", background: "linear-gradient(150deg, #022c22 0%, #064e3b 45%, #0c2340 100%)" }}>
        <svg style={{ position: "absolute", inset: 0, width: "100%", height: "100%", opacity: 0.1 }} viewBox="0 0 600 220" preserveAspectRatio="none">
          {[0, 22, 44].map(o => (
            <path key={o} d={`M0 ${110+o} Q150 ${90+o} 300 ${110+o} T600 ${110+o}`} stroke="#10b981" strokeWidth="1.5" fill="none" />
          ))}
        </svg>
        <div style={{ position: "relative", padding: "20px 20px 20px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 12 }}>
            {[
              ...
              <div key={b.label} style={{ background: "rgba(0,0,0,0.3)", borderRadius: 12, padding: 12, border: "1px solid rgba(16,185,129,0.25)" }}>
          ...
          <div style={{ background: "rgba(0,0,0,0.3)", borderRadius: 12, padding: 12, border: "1px solid rgba(16,185,129,0.25)" }}>
      ...
      <div style={{ marginTop: 8, textAlign: "center", color: "#475569", fontSize: 11, fontWeight: 600 }}>A · Original Gradient</div>
    </div>
  );
}
