export default function GlassFrost() {
  return (
    <div style={{ background: "#030a14", padding: 16, fontFamily: "'Inter', sans-serif" }}>
      <div style={{ borderRadius: 20, overflow: "hidden", position: "relative", background: "linear-gradient(145deg, rgba(255,255,255,0.06) 0%, rgba(255,255,255,0.02) 100%)", border: "1px solid rgba(255,255,255,0.1)", backdropFilter: "blur(20px)" }}>
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(160deg, rgba(16,185,129,0.08) 0%, rgba(3,10,20,0.6) 60%)", pointerEvents: "none" }} />
        <div style={{ position: "relative", padding: "20px 20px 20px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 12 }}>
            {[
              ...
              <div key={b.label} style={{ background: "rgba(255,255,255,0.06)", borderRadius: 12, padding: 12, border: "1px solid rgba(255,255,255,0.1)" }}>
          ...
          <div style={{ background: "rgba(255,255,255,0.06)", borderRadius: 12, padding: 12, border: "1px solid rgba(255,255,255,0.1)" }}>
      ...
      <div style={{ marginTop: 8, textAlign: "center", color: "#475569", fontSize: 11, fontWeight: 600 }}>D · Glass / Frosted</div>
    </div>
  );
}
