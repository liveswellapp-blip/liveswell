import TrestlesScreen from "./TrestlesScreen";

// Phone screen is 264px wide; TrestlesScreen renders at 390px
const SCALE = 264 / 390;
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, padding: "64px 48px 56px", alignItems: "center", maxWidth: 1280, margin: "0 auto" }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
            <button style={{ background: "#34d399", color: "#030a14", border: "none", borderRadius: 10, padding: "14px 32px", fontFamily: "inherit", fontWeight: 800, fontSize: 15, cursor: "pointer" }}>
              Sign in with Replit →
            </button>
        ...
        {/* Right — phone with inline app screen */}
        <div style={{ display: "flex", justifyContent: "center", position: "relative" }}>
          ...
          <div style={{
            ...
            borderRadius: 46,
            background: "#161616",
            boxShadow: "0 0 0 2px #262626, 0 0 0 5px #0d0d0d, 0 36px 72px rgba(0,0,0,0.75), inset 0 0 0 1px rgba(255,255,255,0.07)",
            padding: "10px 8px",
            position: "relative",
            flexShrink: 0,
          }}>
            ...
            <div style={{ borderRadius: 38, overflow: "hidden", background: "#030a14", position: "relative" }}>
              ...
              {/* App content — TrestlesScreen scaled to fill phone width */}
              <div style={{ width: 264, height: 570, overflow: "hidden", position: "relative" }}>
                <div style={{
                  width: 390,
