      ...
      <div className="container mx-auto px-6 py-8">
        <div className="mb-6">
          ...
          <div className="flex items-center space-x-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-emerald-400">Notification Settings</h1>
          </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-slate-300">
                Notification settings require user authentication. The app is currently configured to work without login.
              </p>
              <p className="text-slate-400 text-sm">
                You can still access all surf condition data from the home page.
              </p>
            </CardContent>
          </Card>
        </div>
