    ...
    <div style={{ minHeight: "100vh", background: "#030a14", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      <div style={{ width: "100%", maxWidth: 400 }}>
        ...
        <div style={{ background: "#041a2e", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: "32px 28px" }}>
          <h1 style={{ color: "#e2e8f0", fontSize: 22, fontWeight: 700, margin: "0 0 6px" }}>Create your account</h1>
          <p style={{ color: "#64748b", fontSize: 14, margin: "0 0 28px" }}>Free · No credit card needed</p>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              <label style={{ display: "block", color: "#94a3b8", fontSize: 13, fontWeight: 500, marginBottom: 6 }}>Password <span style={{ color: "#475569", fontWeight: 400 }}>(min. 8 characters)</span></label>
              <input
                type="password"
                value={password}
        ...
        <p style={{ textAlign: "center", color: "#64748b", fontSize: 14, marginTop: 20 }}>
          ...
          <Link href="/login" style={{ color: "#34d399", textDecoration: "none", fontWeight: 500 }}>Sign in</Link>
        </p>
      </div>
    </div>
  );
