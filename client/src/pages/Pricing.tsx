...
:root { --ink:#f8fafc; --muted:#94a3b8; --deep:#030a14; --panel:#0f172a; --line:rgba(52,211,153,.18); --aqua:#34d399; --coral:#f58b7e; }
* { box-sizing:border-box; } .pricing-shell { min-height:100dvh; color:var(--ink); background:radial-gradient(circle at 85% 7%,rgba(16,185,129,.16),transparent 31rem),radial-gradient(circle at 8% 37%,rgba(30,64,175,.12),transparent 24rem),var(--deep); font-family:'DM Sans',sans-serif; overflow:hidden; }
...
.plan-grid{max-width:1060px;margin:auto;padding:0 28px;display:grid;grid-template-columns:.83fr 1.17fr;gap:18px;align-items:stretch}.plan-card{border:1px solid var(--line);border-radius:14px;padding:32px;background:rgba(15,23,42,.78);position:relative}.pro-card{background:linear-gradient(145deg,rgba(6,78,59,.58),rgba(15,23,42,.96));border-color:rgba(52,211,153,.38);box-shadow:0 24px 70px rgba(0,0,0,.32)}.pro-ribbon{position:absolute;top:0;right:28px;padding:7px 11px;background:var(--coral);color:#261511;border-radius:0 0 7px 7px;font:700 9px 'Space Mono',monospace;letter-spacing:.1em}.plan-label{font:700 10px 'Space Mono',monospace;letter-spacing:.12em;text-transform:uppercase;color:var(--muted)}.plan-card h2{font-size:40px;letter-spacing:-.06em;margin:14px 0 8px}.plan-card-top{display:flex;justify-content:space-between;align-items:start}.wave-mark{color:var(--aqua)}.plan-copy{color:var(--muted);line-height:1.6;font-size:14px;min-height:46px;margin:0 0 24px}.billing-toggle{display:flex;gap:7px;background:rgba(2,6,23,.72);padding:5px;border-radius:8px;margin:22px 0 20px;width:max-content}.billing-toggle button{color:var(--muted);background:transparent;border:0;border-radius:5px;padding:8px 12px;font:600 12px 'DM Sans';cursor:pointer}.billing-toggle button.selected{background:rgba(16,185,129,.2);color:#6ee7b7}.billing-toggle button:disabled{cursor:not-allowed;opacity:.62}.billing-toggle small{display:block;color:var(--coral);font-size:9px;margin-top:2px}.price-line{display:flex;align-items:baseline;margin-bottom:5px}.price-line strong{font-size:47px;letter-spacing:-.06em}.price-line span{color:var(--muted);font-size:14px}.button{display:inline-flex;align-items:center;justify-content:center;gap:8px;border:0;border-radius:7px;padding:13px 15px;text-decoration:none;font:700 13px 'DM Sans';cursor:pointer;transition:transform .18s,opacity .18s;width:100%}.button:hover:not(:disabled){transform:translateY(-2px)}.button.primary{background:var(--aqua);color:#022c22}.button.secondary{background:rgba(148,163,184,.1);border:1px solid var(--line);color:var(--ink)}.button.small{width:auto;padding:10px 13px}.button:disabled{opacity:.55;cursor:not-allowed}.secure-line{display:flex;align-items:center;justify-content:center;gap:6px;color:#64748b;font-size:11px;margin:15px 0 25px}.feature-list{border-top:1px solid var(--line);padding-top:20px;margin-top:28px;display:grid;gap:14px}.feature-list div{display:flex;gap:10px;align-items:start;color:#cbd5e1;font-size:13px;line-height:1.35}.feature-list svg{color:var(--aqua);flex:none;margin-top:1px}.free-card .feature-list{margin-top:30px}
.alert{max-width:1060px;margin:0 auto 24px;padding:17px 20px;border-radius:10px;display:flex;align-items:center;gap:13px}.alert strong{display:block;font-size:14px}.alert span{display:block;color:var(--muted);font-size:12px;margin-top:4px;line-height:1.4}.alert button{margin-left:auto;background:transparent;color:var(--coral);border:0;text-decoration:underline;cursor:pointer}.confirmation{border:1px solid rgba(52,211,153,.3);background:rgba(6,78,59,.32)}.confirmation button,.checkout-paused button{color:var(--aqua)}.checkout-paused{border:1px solid rgba(52,211,153,.24);background:rgba(15,23,42,.78)}.pulse-dot{width:9px;height:9px;border-radius:50%;background:var(--aqua);box-shadow:0 0 0 7px rgba(52,211,153,.14)}.success{border:1px solid rgba(52,211,153,.38);background:rgba(6,78,59,.38)}.success-check{background:var(--aqua);color:var(--deep);border-radius:50%;padding:7px;display:flex}.success .button{margin-left:auto}.alert-error{border:1px solid rgba(245,139,126,.45);background:rgba(127,29,29,.22)}.alert-error strong{color:var(--coral)}
