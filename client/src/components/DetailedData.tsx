          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
              ...
              {isLoading ? (
                ...
                <span className="text-lg font-semibold text-blue-900 dark:text-orange-400">
            ...
            <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
              ...
              {isLoading ? (
                ...
                <span className="text-lg font-semibold text-blue-900 dark:text-purple-400">
            ...
            <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
              ...
              {isLoading ? (
                ...
                <span className="text-lg font-semibold text-blue-900 dark:text-yellow-400">
            ...
            <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
              ...
              {isLoading ? (
                ...
                <span className="text-lg font-semibold text-blue-900 dark:text-pink-400">
