        ...
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          ...
          {detailedLoading ? (
            ...
            <div className="space-y-0">
              {/* Header */}
              <div className="flex bg-emerald-50 dark:bg-emerald-900/20 rounded-t-lg font-semibold text-xs py-2.5 gap-2">
              ...
              <div className="max-h-96 overflow-y-auto bg-background rounded-b-lg">
                {detailedData.hourlyData.map((hour, index) => (
                  <div key={index}>
                    <div className="flex text-xs hover:bg-muted/30 transition-colors py-2.5 gap-2">
