        ...
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          ...
          {detailedLoading ? (
            ...
            <div className="space-y-0">
              {/* Header */}
              <div className="flex bg-emerald-50 dark:bg-emerald-900/20 rounded-t-lg font-semibold text-xs py-2.5">
                <div className="w-16 px-2.5">Time</div>
                <div className="w-20 px-3">Waves</div>
                <div className="w-16 px-3">Period</div>
                <div className="w-16 px-3">Wind</div>
                <div className="flex-1 px-2.5">Direction</div>
              </div>
              ...
              <div className="max-h-96 overflow-y-auto bg-background rounded-b-lg">
                {detailedData.hourlyData.map((hour, index) => (
                  <div key={index}>
                    <div className="flex text-xs hover:bg-muted/30 transition-colors py-2.5">
                      <div className="w-16 px-2.5 font-medium text-gray-900 dark:text-gray-100">{hour.time}</div>
                      <div className="w-20 px-3 text-emerald-600 dark:text-emerald-400 font-semibold">
                        {hour.waveHeight}
                        <div className="text-[10px] text-gray-500 dark:text-gray-400 mt-0.5">
                          {hour.waveDirection}
                        </div>
                      </div>
                      <div className="w-16 px-3 text-blue-600 dark:text-blue-400 font-medium">
                        {hour.wavePeriod}
                      </div>
                      <div className="w-16 px-3 text-emerald-600 dark:text-emerald-400 font-semibold">
                        {hour.windSpeed}
                      </div>
                      <div className="flex-1 px-2.5 text-blue-600 dark:text-blue-400 font-medium">
                        {hour.windDirection}
                      </div>
                    </div>
