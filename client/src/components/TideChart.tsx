          ...
          {majorTides.map((tide, index) => (
            <div key={index} className="flex items-center justify-between p-2 bg-white/50 dark:bg-emerald-950/30 rounded-md">
              <div className="flex items-center space-x-2">
                <span className="text-sm font-medium text-gray-700 dark:text-warm-gold">
                  {tide.type === 'high' ? 'High' : 'Low'} Tide
                </span>
              </div>
              <div className="text-right">
                <div className="text-sm font-semibold text-gray-900 dark:text-coral-accent">
                  {tide.time}
                </div>
                <div className="text-xs text-gray-500 dark:text-soft-purple">
