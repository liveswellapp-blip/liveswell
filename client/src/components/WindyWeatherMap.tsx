...
export default function WindyWeatherMap({ location }: WindyWeatherMapProps) {
  ...
  return (
    <div className="w-full">
      ...
      <div className="hidden xl:block" data-testid="card-windy-weather-map">
        <div className="bg-muted rounded-lg border border-border p-4">
          <h3 className="text-lg font-semibold text-blue-900 dark:text-white mb-3">Wind Forecast</h3>
          {/* Interactive Windy Map - Compact */}
          <div className="relative">
            <div className="aspect-[4/3] bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden">
              <iframe
                src={generateWindyUrl()}
          ...
          {/* Provider Attribution */}
          <div className="text-xs text-muted-foreground text-center pt-2 mt-2">
            Data by{" "}
            <a 
              href="https://www.windy.com" 
              target="_blank" 
