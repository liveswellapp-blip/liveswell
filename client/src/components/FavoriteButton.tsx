    ...
    >
      <Heart
        className={`${iconSizes[size]} ${
          isFavorite ? "fill-red-500 text-red-500 dark:fill-salmon-pink dark:salmon-pink" : "text-gray-400 dark:text-emerald-400 hover:text-red-400 dark:hover:salmon-pink"
        }`}
      />
    </Button>
  );
