        ...
        <div className="flex items-center justify-center h-16 w-full">
          ...
          <div className="flex items-center space-x-6 w-full max-w-4xl justify-center">
            ...
            <Button
              ...
              size="default"
              asChild
              className="px-6 py-2 h-10 whitespace-nowrap bg-background hover:bg-muted border-input text-black dark:text-white hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
            >
              <Link href="/favorites">
