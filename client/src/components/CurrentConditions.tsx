          ...
          <div className="rounded-lg p-4 bg-muted text-blue-900 dark:text-emerald-400 border border-border">
            ...
            <div className="flex items-end space-x-2">
              {isLoading ? (
                ...
                <>
                  <span className="text-3xl font-bold text-blue-900 dark:text-white">{conditions?.waveHeight || "0"}</span>
              ...
              <div className="flex-1">
                <div className="flex items-end space-x-2">
                  {isLoading ? (
                    ...
                    <>
                      <span className="text-3xl font-bold text-blue-900 dark:text-white">{conditions?.windSpeed || "0"}</span>
          ...
          <div className="rounded-lg p-4 bg-muted text-blue-900 dark:text-emerald-400 border border-border">
            ...
            <div className="flex items-end space-x-2">
              {isLoading ? (
                ...
                <>
                  <span className="text-3xl font-bold text-blue-900 dark:text-white">{conditions?.tideHeight || "0"}</span>
                  <span className="text-lg mb-1">ft</span>
                </>
              )}
            </div>
