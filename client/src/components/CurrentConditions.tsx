...
export default function CurrentConditions({ location }: CurrentConditionsProps) {
  ...
  const tideSource: string | undefined = (conditions as any)?.tideSource;
        ...
        >
          ...
          {!isLoading && primaryBuoy && (
            <div className={`px-4 pb-4 ${backupBuoy ? 'grid grid-cols-2 gap-px' : ''}`}>
              ...
              {/* ── Buoy #1 column ── */}
              <div className={backupBuoy ? 'pr-4 flex flex-col' : ''}>
              ...
              {/* ── Buoy #2 column ── */}
              {backupBuoy && (
                <div className="pl-4 border-l border-white/[0.08] flex flex-col">
                  <p className="text-white font-semibold truncate text-[12px]">
        ...
        {conditions && (
          <div className="rounded-xl border border-white/[0.08] overflow-hidden" style={{ background: "linear-gradient(160deg, #030912 0%, #091a35 100%)" }}>
            ...
            <div className="px-4 pb-3 flex items-center justify-between gap-4">
              ...
              <button
                className="bg-sky-400/15 border border-sky-400/30 rounded-lg px-3 py-1.5 hover:bg-sky-400/25 transition-colors shrink-0 text-[#38bdf8] text-[11px] font-medium"
