    ...
    <section className="container mx-auto px-4 py-6">
      <Card className="bg-white rounded-xl shadow-lg p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Tide Information */}
          <div className="bg-gradient-to-br from-sea-green to-sky-blue rounded-lg p-4 text-[#000000]">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center space-x-2">
          ...
          {/* Wind Conditions */}
          <div className="from-sunset-orange to-yellow-400 rounded-lg p-4 text-[#000000] bg-[#efefef]">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center space-x-2">
