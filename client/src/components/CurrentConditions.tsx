    ...
    <div className="w-full">
      ...
      <div className="container mx-auto px-4 md:px-6 mb-6 lg:mb-4 max-w-7xl">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-4">
          ...
          <div className="col-span-2 lg:col-span-3 rounded-lg p-4 lg:p-3 bg-muted text-blue-900 dark:text-white border border-border">
            <div className="flex items-center space-x-2 mb-4 lg:mb-3">
